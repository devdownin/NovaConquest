...
| C4 | 🟡 Design — ✅ corrigé | Transport | L'embarquement est une action **gratuite** : ni l'escorte ni le porte-vaisseaux ne sont marqués comme ayant agi |
...
| V4 | 🟡 Faible — ✅ corrigé | Victoire | La victoire territoriale Zodiac balaie `Faction.values()`, **`ANCIENT_NPC` compris** |
