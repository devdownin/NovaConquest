...
| P4 | 💡 Design | Équilibrage | Durée de construction quasi **plate** : un éclaireur (3 C) prend autant de tours qu'un cuirassé (18 C) |
| P5 | 🟡 Faible | Production | Un ordre dont la zone d'apparition reste bloquée se **réarme indéfiniment** à 1 tour restant |
| P6 | 💡 Design | IA | La production IA suit un ordre fixe « le plus cher d'abord », sans tenir compte de sa posture |
